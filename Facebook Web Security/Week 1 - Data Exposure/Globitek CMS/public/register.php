<?php
     ...
     else if(!charCheck($first_name, 'name')){                                   //If first_name has invalid characters
     ...
     else if(!charCheck($last_name, 'name')){                                       //If last_name had invalid characters
     ...
     else if(!charCheck($email, 'email')){                           //If email has invalid characters
     ...
     else if(!charCheck($username, 'username')){                          //If username has invalid characters
