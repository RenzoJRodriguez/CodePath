<?php
  ...
  function log_in_user($user) {
       //After a successful log in, Session ID is regenerated (to prevent Session Fixation)  and Session variables are set
  ...
  function last_login_is_recent() {
    $recent_limit = 24*60*60;    //This is one day; Matches session cookie limit
