...
if(is_post_request() && request_is_same_domain()) {
  ...
  if(isset($_POST['previous_password'])) { $user['previous_password'] = $_POST['previous_password']; }
...
<div id="main-content">
  ...
  <form action="edit.php?id=<?php echo h(u($user['id'])); ?>" method="post">
    ...
    New Password:<br />
    <input type="password" name="new_password" value="" />Strong password suggestion: <?php echo generate_strong_password(); ?>
    <br />
    Confirm password:<br />
    <input type="password" name="confirm_password" value="" /><br />
    <br />
    <br />
    Password should be at least 12 characters and include at least one uppercase letter,lowercase letter,number,and symbol.<br />
    <br />
